            ...
            <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <Input name="full_name" className="bg-card text-card-foreground border border-border" value={patientData.full_name} onChange={e => handleInputChange("full_name", e.target.value)} required />
                    </div>
                    <div>
                        <Label>Email</Label>
                        <Input name="email" className="bg-card text-card-foreground border border-border" value={patientData.email} onChange={e => handleInputChange("email", e.target.value)} type="email" />
                    </div>
                    <div>
                        <Label>Teléfono</Label>
                        <Input name="phone" className="bg-card text-card-foreground border border-border" value={patientData.phone} onChange={e => handleInputChange("phone", e.target.value)} />
                    </div>
                    <div>
                        <Label>Fecha de nacimiento</Label>
                        <Input name="date_of_birth" className="bg-card text-card-foreground border border-border" value={patientData.date_of_birth} onChange={e => handleInputChange("date_of_birth", e.target.value)} type="date" />
                    </div>
                    <div className="md:col-span-2">
                        <Label>Dirección</Label>
                        <Input name="address" className="bg-card text-card-foreground border border-border" value={patientData.address} onChange={e => handleInputChange("address", e.target.value)} />
                    </div>
                    <div>
                        <Label>Contacto de emergencia</Label>
                        <Input name="emergency_contact" className="bg-card text-card-foreground border border-border" value={patientData.emergency_contact} onChange={e => handleInputChange("emergency_contact", e.target.value)} />
                    </div>
                    <div>
                        <Label>Teléfono de emergencia</Label>
                        <Input name="emergency_phone" className="bg-card text-card-foreground border border-border" value={patientData.emergency_phone} onChange={e => handleInputChange("emergency_phone", e.target.value)} />
                    </div>
                    <div className="md:col-span-2">
